...
public class TimingActivity extends TaskContent {
    ...
    public int timingActivity() throws Exception {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (!AtFairyConfig.getOption("zzjt").equals("") && (w == 2 || w == 4) && (h == 20 || (h == 19 && m >= 59)) && jzls == 0) {
            ...
            if (AtFairyConfig.getOption("swjz").equals("1") && w != 7  && h > 14 && (h < 19 && m < 10) && jzqd.size() != 0 && jzqd1 == 0) {
    ...
    public void zzjt() throws Exception {
        new TimingActivity(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(949,118,1094,656, "jrzc.png");
    ...
    public void cfjj() throws Exception {
        new TimingActivity(mFairy) {
            ...
            public void content_3() throws Exception {
                ...
                result2 = mFairy.findPic(932,41,1151,249,"zhankuang.png");
