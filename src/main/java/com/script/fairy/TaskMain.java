        ...
        switch (task_id) {
            ...
            case 2023:
                while (mFairy.condit()) {
                    ...
                    if (AtFairyConfig.getOption("jzjh").equals("1") && h == 19 && (mFairy.dateMinute() >15 && mFairy.dateMinute() <30)) {
                        gameUtil.lkfb();
                        gameUtil.cancelFollowing();
                        if (w == 6 || w == 7) {
                    ...
                    if (AtFairyConfig.getOption("kjxs").equals("1") && w != 6 && w != 7 && h >= 19 && h < 22) {
                        gameUtil.lkfb();
                        gameUtil.cancelFollowing();
                        timingActivity.kjxs();
                    }
                    ...
                    if (!AtFairyConfig.getOption("ryjjc").equals("") && (w == 1 || w == 3 || w == 5) && h == 21) {
                        gameUtil.lkfb();
                        gameUtil.cancelFollowing();
            ...
            case 2031:
                ...
                if (AtFairyConfig.getOption("dw").equals("1")) {
                    ...
                    if (AtFairyConfig.getOption("fb15").equals("1")) {
                        teamTask.dlfb("ptlzdtask.png", "ptlzd1.png", "ptlzd.png", 0);
                    }
                    ...
                    if (AtFairyConfig.getOption("fb16").equals("1")) {
                        teamTask.dlfb("tzlzdtask.png", "tzlzd1.png", "tzlzd.png", 1);
                    }

                    if (AtFairyConfig.getOption("fb18").equals("1")) {
                        teamTask.dlfb("tzqystask.png", "tzqys1.png", "tzqys.png", 1);
                    }

                    if (AtFairyConfig.getOption("fb20").equals("1")) {
                        teamTask.dlfb("tzklxtask.png", "tzklx1.png", "tzklx.png", 1);
                    }
                ...
                if (AtFairyConfig.getOption("dw").equals("2")) {
                    ...
                    if (AtFairyConfig.getOption("fb15").equals("1")) {
                        teamTask.gdfb("ptlzdtask.png", "ptlzd1.png", "ptlzd.png", 0);
                    }
                    if (AtFairyConfig.getOption("fb17").equals("1")) {
                    ...
                    if (AtFairyConfig.getOption("fb16").equals("1")) {
                        teamTask.gdfb("tzlzdtask.png", "tzlzd1.png", "tzlzd.png", 1);
                    }
